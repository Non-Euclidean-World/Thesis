...
To make the game more fun to play, we included several features, such as NPCs (non-playable characters, also known as \textit{bots}) in the form of humanoids that the player can interact with, a car that the player can drive around, and items that the player can use to perform various actions.
