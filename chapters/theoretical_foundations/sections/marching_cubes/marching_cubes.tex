...
Numerous algorithms exist for this purpose, and the chosen algorithm for our project is known as \textit{marching cubes}.
...
Then, the \textit{isolevel} is chosen, 0 being the most common choice and the one we used.
Points of the scalar field with values greater than the isolevel are considered to be "above" the surface, while points with values lower than the isolevel are considered to be "below" the surface.
