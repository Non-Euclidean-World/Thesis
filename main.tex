...
\question{What should be included in "Specyfikacja Funkcjonalna" (and where to place it? Should it be included at all?) Just the user stories or maybe the whole deliverable 1?}

\question{Is this thesis structure proposal ok?:
  \begin{enumerate}
    \item Introduction
...
\question{Can the images be located in different places (\texttt{H} vs \texttt{h} modifier). Should images be positions to be right next to the text that references them or where they look nice and don't leave gaps in the text?}
\input{chapters/theoretical_foundations/theoretical_foundations.tex}
\input{chapters/system_architecture/system_architecture.tex}
\input{chapters/main_components/main_components.tex}
\input{chapters/lighting/lighting.tex}
\input{chapters/tests/tests.tex}
\input{chapters/user_manual/user_manual.tex}
\input{chapters/results/results.tex}
\input{chapters/problems/problems.tex}
\input{chapters/improvements/improvements.tex}
